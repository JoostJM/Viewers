  ...
  const renderReferenceLines = ({ detail: { enabledElement } }) => {
    ...
    cornerstone
      ...
      .forEach(async referenceElement => {
        ...
        console.log(targetImagePlane);
        console.log(referenceImagePlane);
        const points = planeIntersection(targetImagePlane, referenceImagePlane);
        console.log(planeIntersection(targetImagePlane, referenceImagePlane));
        console.log(planeIntersection(referenceImagePlane, targetImagePlane));
